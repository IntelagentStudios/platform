...
export class AbandonedCartRecoverySkill extends BaseSkill {
  metadata = {
    ...
    version: '2.0.0',
    author: 'Intelagent',
    tags: ["ecommerce","abandoned-cart-recovery"]
  };
  ...
  async execute(params: SkillParams): Promise<SkillResult> {
    try {
      ...
      const result = await this.processAbandonedCartRecovery(params);
  ...
  private async processAbandonedCartRecovery(params: SkillParams): Promise<any> {
    ...
    console.log(`[AbandonedCartRecoverySkill] Processing ${action} for license ${licenseKey}, task ${taskId}`);
