...
export class CertificateGeneratorSkill extends BaseSkill {
  metadata = {
    ...
    version: '2.0.0',
    author: 'Intelagent',
    tags: ["education","certificate-generator"]
  };
  ...
  protected async executeImpl(params: SkillParams): Promise<SkillResult> {
    try {
      ...
      const result = await this.processCertificateGenerator(params);
  ...
  private async processCertificateGenerator(params: SkillParams): Promise<any> {
    ...
    console.log(`[CertificateGeneratorSkill] Processing ${action} for license ${licenseKey}, task ${taskId}`);
