...
export class ComputerVisionSkill extends BaseSkill {
  metadata = {
    id: 'computer_vision',
  ...
  protected async executeImpl(params: SkillParams): Promise<SkillResult> {
    try {
      ...
      const result = await this.processComputerVision(params);
  ...
  private async processComputerVision(params: SkillParams): Promise<any> {
    ...
    console.log(`[ComputerVisionSkill] Processing ${action} for license ${licenseKey}, task ${taskId}`);
