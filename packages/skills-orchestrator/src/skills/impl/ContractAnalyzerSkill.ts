...
export class ContractAnalyzerSkill extends BaseSkill {
  metadata = {
  ...
  async execute(params: SkillParams): Promise<SkillResult> {
    try {
      ...
      const result = await this.processContractAnalyzer(params);
  ...
  private async processContractAnalyzer(params: SkillParams): Promise<any> {
    ...
    console.log(`[ContractAnalyzerSkill] Processing ${action} for license ${licenseKey}, task ${taskId}`);
