...
export class CourseCreatorSkill extends BaseSkill {
  metadata = {
    id: 'course_creator',
    name: 'Course Creator',
  ...
  async execute(params: SkillParams): Promise<SkillResult> {
    try {
      ...
      const result = await this.processCourseCreator(params);
  ...
  private async processCourseCreator(params: SkillParams): Promise<any> {
    ...
    console.log(`[CourseCreatorSkill] Processing ${action} for license ${licenseKey}, task ${taskId}`);
