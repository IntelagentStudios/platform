...
export class EmailParserSkill extends BaseSkill {
  metadata = {
    id: 'email_parser',
    name: 'Email Parser',
  ...
  async execute(params: SkillParams): Promise<SkillResult> {
    try {
      ...
      const result = await this.processEmailParser(params);
  ...
  private async processEmailParser(params: SkillParams): Promise<any> {
    // Simulate processing
