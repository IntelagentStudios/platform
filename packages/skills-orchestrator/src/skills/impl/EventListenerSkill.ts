...
export class EventListenerSkill extends BaseSkill {
  metadata = {
    id: 'event_listener',
    name: 'Event Listener',
    description: 'Internal event listener implementation',
  ...
  async execute(params: SkillParams): Promise<SkillResult> {
    try {
      ...
      console.log(`[Event Listener] Executing for license ${licenseKey}, task ${contextTaskId}`);
  ...
  private async queueMessage(message: any): Promise<void> {
    console.log('[Event Listener] Message queued:', message);
  }
  ...
  private async analyzeEventListener(data: any): Promise<any> {
    return {
      result: 'analyzed',
      confidence: 0.95,
      data
  ...
  private async scheduleTask(id: string, task: any, schedule: any): Promise<void> {
    console.log(`[Event Listener] Task scheduled: ${id}`);
  }
  
  private async executeTask(id: string, task: any): Promise<void> {
    console.log(`[Event Listener] Task executed: ${id}`);
  }
  ...
  private async processEventListener(entity: any): Promise<any> {
