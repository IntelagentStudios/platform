...
export class FraudDetectorSkill extends BaseSkill {
  metadata = {
    id: 'fraud_detector',
    name: 'Fraud Detector',
  ...
  protected async executeImpl(params: SkillParams): Promise<SkillResult> {
    try {
      ...
      const result = await this.processFraudDetector(params);
  ...
  private async processFraudDetector(params: SkillParams): Promise<any> {
    ...
    console.log(`[FraudDetectorSkill] Processing ${action} for license ${licenseKey}, task ${taskId}`);
