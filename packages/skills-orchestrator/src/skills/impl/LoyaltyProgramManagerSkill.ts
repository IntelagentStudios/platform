...
export class LoyaltyProgramManagerSkill extends BaseSkill {
  metadata = {
    ...
    version: '2.0.0',
    author: 'Intelagent',
    tags: ["ecommerce","loyalty-program-manager"]
  };
  ...
  protected async executeImpl(params: SkillParams): Promise<SkillResult> {
    try {
      ...
      const result = await this.processLoyaltyProgramManager(params);
  ...
  private async processLoyaltyProgramManager(params: SkillParams): Promise<any> {
    ...
    console.log(`[LoyaltyProgramManagerSkill] Processing ${action} for license ${licenseKey}, task ${taskId}`);
