...
export class NlpProcessorSkill extends BaseSkill {
  metadata = {
    id: 'nlp_processor',
    name: 'Nlp Processor',
  ...
  protected async executeImpl(params: SkillParams): Promise<SkillResult> {
    try {
      ...
      const result = await this.processNlpProcessor(params);
  ...
  private async processNlpProcessor(params: SkillParams): Promise<any> {
    ...
    console.log(`[NlpProcessorSkill] Processing ${action} for license ${licenseKey}, task ${taskId}`);
