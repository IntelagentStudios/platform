...
export class QualityScorerSkill extends BaseSkill {
  ...
  async execute(params: SkillParams): Promise<SkillResult> {
    try {
      ...
      const result = await this.processQualityScorer(params);
  ...
  private async processQualityScorer(params: SkillParams): Promise<any> {
    ...
    console.log(`[QualityScorerSkill] Processing ${action} for license ${licenseKey}, task ${taskId}`);
