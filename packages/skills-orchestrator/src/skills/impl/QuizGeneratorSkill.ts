...
export class QuizGeneratorSkill extends BaseSkill {
  metadata = {
    id: 'quiz_generator',
    name: 'Quiz Generator',
  ...
  async execute(params: SkillParams): Promise<SkillResult> {
    try {
      ...
      const result = await this.processQuizGenerator(params);
  ...
  private async processQuizGenerator(params: SkillParams): Promise<any> {
    ...
    console.log(`[QuizGeneratorSkill] Processing ${action} for license ${licenseKey}, task ${taskId}`);
