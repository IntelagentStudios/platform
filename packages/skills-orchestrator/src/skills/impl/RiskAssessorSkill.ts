...
export class RiskAssessorSkill extends BaseSkill {
  metadata = {
    id: 'risk_assessor',
    name: 'Risk Assessor',
  ...
  protected async executeImpl(params: SkillParams): Promise<SkillResult> {
    try {
      ...
      const result = await this.processRiskAssessor(params);
  ...
  private async processRiskAssessor(params: SkillParams): Promise<any> {
    ...
    console.log(`[RiskAssessorSkill] Processing ${action} for license ${licenseKey}, task ${taskId}`);
