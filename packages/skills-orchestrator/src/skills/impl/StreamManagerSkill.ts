...
export class StreamManagerSkill extends BaseSkill {
  metadata = {
    id: 'stream_manager',
    name: 'Stream Manager',
  ...
  async execute(params: SkillParams): Promise<SkillResult> {
    try {
      ...
      const result = await this.processStreamManager(params);
  ...
  private async processStreamManager(params: SkillParams): Promise<any> {
    ...
    console.log(`[StreamManagerSkill] Processing ${action} for license ${licenseKey}, task ${taskId}`);
